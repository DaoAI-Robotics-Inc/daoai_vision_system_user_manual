半有序快速关键点 （Semi-Ordered Fast Keypoint） 检测流程高级配置
==================================

本章会详细介绍如何优化 半有序快速关键点 （Semi-Ordered Fast Keypoint） 检测流程，以及它所提供的高级检测配置。
...
物体位姿过滤
    ...
    - 倾斜范围，当匹配到的物体，相对与定义物体时的位置坐标的任意（rx,ry）值超出所设定的范围，那么改物体检测结果会被移除。
